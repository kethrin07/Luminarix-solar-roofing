...
export default function Footer() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) consultRef.current?.classList.add('visible')
      },
      { threshold: 0.3 }
    )
    if (consultRef.current) observer.observe(consultRef.current)
  ...
  return (
    <>
      ...
      <section className="consult-section" ref={consultRef}>
        <div className="consult-inner">
          <div className="consult-left-anim">
